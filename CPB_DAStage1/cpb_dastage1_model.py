...
class cpb_dastage1_model(object):
    ...
    def build_model(self):
        ...
        # feature consistency in scale 1
        self.tar_fea_cons_sc1 = self.ContentPreservedBlock([self.feature_target[0], self.feature_target[1]],
                                                           ksize=3,
                                                           scope_name='cpb1',
                                                           is_training=self.is_training,
                                                           adjustScale=False,
        ...
        self.D_src_fea_sc1 = self.Discriminator(self.feature_source[1],
                                                ksize=3,
                                                scope_name='d1',
                                                is_training=self.is_training,
        ...
        self.D_tar_fea_sc1 = self.Discriminator(self.feature_target[1],
                                                ksize=3,
                                                scope_name='d1',
                                                is_training=self.is_training,
                                                keep_rate=self.keep_rate,
        ...
        with tf.variable_scope('loss'):
            ...
            self.cpb_input = self.tar_fea_cons_sc1
            self.cpb_output = self.feature_target[0]
            ...
            self.target_gloss = tf.reduce_mean(
                tf.nn.sigmoid_cross_entropy_with_logits(logits=self.D_tar_fea_sc1,
            ...
            self.source_dloss = tf.reduce_mean(
                tf.nn.sigmoid_cross_entropy_with_logits(logits=self.D_src_fea_sc1,
        ...
        with tf.variable_scope('optimization_variables'):
            ...
            self.cpb_var = [var for var in self.t_var if 'cpb1' in var.name]
            self.d_var = [var for var in self.t_var if 'd1' in var.name]
